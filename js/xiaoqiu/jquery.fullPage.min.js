...
(function(a) {
    a.fn.fullpage = function(c) {
        function ea() {
            ...
            l = a("#fp-nav");
            l.css("color", c.navigationColor);
            l.addClass(c.navigationPosition);
            for (var b = 0; b < a(".fp-section").length; b++) {
                var d = "";
                c.anchors.length && (d = c.anchors[b]);
                var e = c.navigationTooltips[b];
                "undefined" === typeof e && (e = "");
                l.find("ul").append('<li data-tooltip="' + e + '"><a href="#' + d + '"><span></span></a></li>')
            }
        }
        ...
        function M() {
            if (!c.autoScrolling) {
                ...
                if (!d.hasClass("active")) {
                    ...
                    a.isFunction(c.onLeave) && c.onLeave.call(this, e, d.index(".fp-section") + 1,
                        f);
                    a.isFunction(c.afterLoad) && c.afterLoad.call(this, h, d.index(".fp-section") + 1);
                    F(h);
                    G(h, 0);
                    c.anchors.length && !u && (v = h, location.hash = h);
                    clearTimeout(N);
        ...
        function x(b, d) {
            ...
            if (0 < d.length)
                if (c = "top" === c ? !d.scrollTop() : "bottom" === c ? d.scrollTop() +
                    1 + d.innerHeight() >= d[0].scrollHeight : void 0, c) f();
                else return !0;
            else f()
        }
        ...
        function fa(b) {
            ...
            if (!P(b.target)) {
                ...
                var e = O(b);
                u || t || (d = Q(d), n = d.y, y = d.x, b.find(".fp-slides").length && Math.abs(z - y) > Math.abs(q - n) ? Math.abs(z - y) > a(window).width() / 100 * c.touchSensitivity && (z > y ? a.fn.fullpage.moveSlideRight() : a.fn.fullpage.moveSlideLeft()) : c.autoScrolling && Math.abs(q - n) > a(window).height() / 100 * c.touchSensitivity && (q > n ? x("down", e) : n > q &&
                    x("up", e)))
            }
        }
        ...
        function r(b, d, e) {
            ...
            if ("undefined" !== typeof h) {
                var h = h.top,
                    A = E(b),
                    g = b.data("anchor"),
                    l = b.index(".fp-section"),
                    k = b.find(".fp-slide.active"),
                    B = a(".fp-section.active"),
                    t = B.index(".fp-section") + 1,
                    m = C;
                if (k.length) var p =
                    k.data("anchor"),
                    r = k.index();
                if (c.autoScrolling && c.continuousVertical && "undefined" !== typeof e && (!e && "up" == A || e && "down" == A)) {
                    e ? a(".fp-section.active").before(B.nextAll(".fp-section")) : a(".fp-section.active").after(B.prevAll(".fp-section").get().reverse());
                    s(a(".fp-section.active").position().top);
                    S();
                    var n = B,
                        h = b.position(),
                        h = h.top,
                ...
                u = !0;
                "undefined" !== typeof g && T(r, p, g);
                c.autoScrolling ? (f.top = -h, b = ".fullpage-wrapper") : (f.scrollTop = h, b = "html, body");
                var q = function() {
                    n && n.length && (e ? a(".fp-section:first").before(n) : a(".fp-section:last").after(n), s(a(".fp-section.active").position().top), S());
                    a.isFunction(c.afterLoad) && !m && c.afterLoad.call(this, g, l + 1);
                    setTimeout(function() {
                        u = !1;
                        a.isFunction(d) && d.call(this)
                    }, 600)
                };
                a.isFunction(c.onLeave) && !m && c.onLeave.call(this, t, l + 1, A);
                c.css3 && c.autoScrolling ? (U("translate3d(0px, -" + h + "px, 0px)", !0), setTimeout(function() {
                    q()
                }, c.scrollingSpeed)) : a(b).animate(f, c.scrollingSpeed, c.easing, function() {
                    q()
                });
                v = g;
                c.autoScrolling &&
            ...
            if (!D) {
                ...
                if (a.length) {
                    var c = "undefined" === typeof v,
                        f = "undefined" === typeof v && "undefined" === typeof b && !t;
                    (a && a !== v && !c || f || !t && I != b) && J(a, b)
                }
            }
        }
        ...
        function p(b, d) {
            var e = d.position(),
                ...
                l = g.index(".fp-section"),
                k = g.data("anchor"),
                n = g.find(".fp-slidesNav"),
                m = d.data("anchor"),
                q = C;
            if (c.onSlideLeave) {
                var p = g.find(".fp-slide.active").index(),
                    r;
                r = p == h ? "none" : p > h ? "left" : "right";
                q || a.isFunction(c.onSlideLeave) && c.onSlideLeave.call(this, k, l + 1, p, r)
            }
            d.addClass("active").siblings().removeClass("active");
            "undefined" === typeof m && (m = h);
            c.loopHorizontal || (g.find(".fp-controlArrow.fp-prev").toggle(0 != h), g.find(".fp-controlArrow.fp-next").toggle(!d.is(":last-child")));
            g.hasClass("active") && T(h, m, k);
            var s = function() {
                q || a.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this, k, l + 1, m, h);
                t = !1
            };
            c.css3 ? (e = "translate3d(-" + e.left + "px, 0px, 0px)", b.find(".fp-slidesContainer").toggleClass("fp-easing",
                0 < c.scrollingSpeed).css(W(e)), setTimeout(function() {
                s()
            ...
            n.find("li").eq(h).find("a").addClass("active")
        }

        function X() {
            K ? a.fn.fullpage.reBuild() : (clearTimeout(Y), Y = setTimeout(a.fn.fullpage.reBuild, 500))
        }

        function ha(b, c) {
            if (825 > b || 900 > c) {
                var e = Math.min(100 * b / 825, 100 * c / 900).toFixed(2);
        ...
        function $(b) {
            b.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + aa(b) + 'px;" />')
        }

        function aa(b) {
            var a = k;
            if (c.paddingTop || c.paddingBottom) a = b, a.hasClass("fp-section") || (a = b.closest(".fp-section")), b = parseInt(a.css("padding-top")) + parseInt(a.css("padding-bottom")), a = k - b;
            return a
        }

        function U(b, a) {
            g.toggleClass("fp-easing", a);
            g.css(W(b))
        }
        ...
        function J(b, c) {
            ...
            b === v || e.hasClass("active") ? ba(e, c) : r(e, function() {
                ba(e, c)
            })
        }
        ...
        function T(a, d, e) {
            var f = "";
            c.anchors.length && (a ? ("undefined" !== typeof e && (f = e), "undefined" === typeof d && (d = a), I = d, location.hash = f + "/" + d) : ("undefined" !== typeof a && (I = d), location.hash = e))
        }
        ...
        function Q(a) {
            var c = [];
            window.navigator.msPointerEnabled ? (c.y = a.pageY, c.x = a.pageX) : (c.y = a.touches[0].pageY,
        ...
        function H(b) {
            ...
            p(b.closest(".fp-slides"), b);
            a.fn.fullpage.setScrollingSpeed(d)
        }

        function s(a) {
            c.css3 ? U("translate3d(0px, -" + a + "px, 0px)", !1) : g.css("top", -a)
        }
        ...
        function ka() {
            ...
            g.find(".fp-easing").removeClass("fp-easing");
        ...
        a.fn.fullpage.setAutoScrolling = function(b) {
            ...
            c.autoScrolling ? (a("html, body").css({
                ...
                (a("html, body").css({
                    ...
                    "-ms-touch-action": "",
                    "touch-action": ""
                }), s(0), a("html, body").scrollTop(b.position().top))
        };
        a.fn.fullpage.setScrollingSpeed = function(a) {
            c.scrollingSpeed = a
        };
        a.fn.fullpage.setMouseWheelScrolling = function(a) {
            a ? document.addEventListener ? (document.addEventListener("mousewheel", m, !1), document.addEventListener("wheel", m, !1)) : document.attachEvent("onmousewheel", m) : document.addEventListener ? (document.removeEventListener("mousewheel", m, !1),
                document.removeEventListener("wheel", m, !1)) : document.detachEvent("onmousewheel", m)
        };
        a.fn.fullpage.setAllowScrolling = function(b) {
            if (b) {
                if (a.fn.fullpage.setMouseWheelScrolling(!0), K || da) MSPointer = ca(), a(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, ga), a(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, fa)
            } else if (a.fn.fullpage.setMouseWheelScrolling(!1), K || da) MSPointer = ca(), a(document).off("touchstart " + MSPointer.down), a(document).off("touchmove " +
                MSPointer.move)
        };
        ...
        var t = !1,
            K = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),
        ...
        a(this).length ? (g.css({
            height: "100%",
            position: "relative"
        }), g.addClass("fullpage-wrapper")) : console.error("Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
        ...
        a(".fp-section").each(function(b) {
            ...
            if (1 < f) {
                ...
                c.slidesNavigation && ia(a(this), f);
                e.each(function(b) {
                    a(this).css("width", g + "%");
                    c.verticalCentered && $(a(this))
                });
                d = d.find(".fp-slide.active");
                0 == d.length ? e.eq(0).addClass("active") : H(d)
            ...
            b.length && (0 != a(".fp-section.active").index(".fp-section") || 0 == a(".fp-section.active").index(".fp-section") && 0 != b.index()) && H(b);
            c.fixedElements && c.css3 && a(c.fixedElements).appendTo("body");
            c.navigation && (l.css("margin-top", "-" + l.height() / 2 + "px"), l.find("li").eq(a(".fp-section.active").index(".fp-section")).find("a").addClass("active"));
            c.menu && c.css3 && a(c.menu).closest(".fullpage-wrapper").length && a(c.menu).appendTo("body");
            c.scrollOverflow ?
                (g.hasClass("fullpage-used") && L(), a(window).on("load", L)) : a.isFunction(c.afterRender) && c.afterRender.call(this);
            b = window.location.hash.replace("#", "").split("/")[0];
            if (b.length) {
                var d = a('[data-anchor="' + b + '"]');
                !c.animateAnchor && d.length && (c.autoScrolling ? s(d.position().top) : (s(0), a("html, body").scrollTop(d.position().top)), F(b), G(b, null), a.isFunction(c.afterLoad) && c.afterLoad.call(this, b, d.index(".fp-section") + 1), d.addClass("active").siblings().removeClass("active"))
            }
        ...
        a.fn.fullpage.moveTo = function(b, c) {
            ...
            "undefined" !== typeof c ? J(b, c) : 0 < e.length && r(e)
        };
        ...
        a(document).keydown(function(b) {
            if (c.keyboardScrolling && !u) switch (b.which) {
                case 38:
                case 33:
        ...
        a.fn.fullpage.reBuild = function() {
            ...
            a(".fp-section").each(function() {
                ...
                b.length && p(b, b.find(".fp-slide.active"))
            });
        ...
        a.fn.fullpage.destroy = function(b) {
            ...
            a(window).off("scroll", M).off("hashchange", V).off("resize", X);
...
})(jQuery); /*  |xGv00|55a6351e4ae842a7caa755617341b12a */